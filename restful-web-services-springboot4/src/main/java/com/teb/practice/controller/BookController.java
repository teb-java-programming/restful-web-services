...
public class BookController {
    ...
    public EntityModel<?> getBookById(@PathVariable String bookId) {
         ...
         */
        EntityModel<?> bookResource = EntityModel.of(bookToLookup);
    ...
    public ResponseEntity<?> addNewBook(@Valid @RequestBody Book book) {
        ...
        /* Returns an HTTP code while adding a new record */
